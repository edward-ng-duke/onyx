...
export default function MessageSwitcher({
  ...
  const disabledMessage = t("switcherDisabledTooltip");
  ...
  return (
    ...
    >
      <Button
        ...
        onClick={previous}
        prominence="tertiary"
        tooltip={disableForStreaming ? disabledMessage : t("previousTooltip")}
      />
      ...
      <Button
        ...
        onClick={next}
        prominence="tertiary"
        tooltip={disableForStreaming ? disabledMessage : t("nextTooltip")}
      />
    </div>
  );
}
