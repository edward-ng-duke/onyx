...
import { useToolName } from "@/app/app/message/messageComponents/toolDisplayHelpers";
    ...
    const groups: NestedToolGroup[] = Array.from(nestedBySubTurn.entries())
      ...
      .map(([subTurnIndex, toolPackets]) => {
        ...
        return {
          ...
          toolType: name,
          status: isComplete ? t("complete") : t("running"),
          isComplete,
          packets: toolPackets,
        };
      });
